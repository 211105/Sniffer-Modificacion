...
const Table = () => {
	...
	// 	try {
	// 		const response = await fetch('http://localhost:5000/sniff/csv/', {
	// 			method: 'GET',
	// 			headers: {
	...
	// 			// Genera la URL de Telegram
	// 			const telegramUrl = `https://telegram.me/Snifferup_bot?text=${encodeURIComponent(csvUrl)}`;

	// 			// Redirecciona a la URL de Telegram
		...
		<>
			...
			<main>
				<div className="head-title">
					...
					<a href="#" className="btn-download" onClick={handleTelegramClick}>
						<i className="bx bxl-telegram"></i>
						<span className="link-text">Send Telegram</span>
					</a>
